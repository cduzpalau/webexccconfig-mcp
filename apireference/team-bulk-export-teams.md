[Home](https://developer.webex.com/)/[Team](https://developer.webex.com/webex-contact-center/docs/api/v1/team)/Bulk export Team(s)
...
**Operation Id:** bulkExport\_4

**Description:**

Export all Team(s) in a given organization.

GET/organization/ **{orgid}**/team/bulk-export
...
- -BulkExportDTOTeamBulkExportDTO
  ...
  - +resources:TeamBulkExportDTO\[\]
    ...
    - +queueRankings:QueueRankingBulkExportDTO\[\]
...
GET/organization//team/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//team/bulk-export \
