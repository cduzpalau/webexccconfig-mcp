[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/Delete specific Contact Number by ID
...
Resource ID of the Contact Number.
...
DELETE/organization//contact-number/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//contact-number/{id} \
