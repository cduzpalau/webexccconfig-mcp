[Home](https://developer.webex.com/)/[Agent Personal Greeting](https://developer.webex.com/webex-contact-center/docs/api/v1/agent-personal-greeting)/Delete specific Greeting File by ID
...
**Operation Id:** deleteConfig\_24

**Description:**

Delete an existing Greeting File by ID for a given organization.

DELETE/organization/ **{orgid}/agent-personal-greeting/{id}**
...
DELETE/organization//agent-personal-greeting/ **{id}**
