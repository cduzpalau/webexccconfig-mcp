[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Purge inactive Auxiliary Code(s)
...
**Operation Id:** purgeInactiveConfig\_10

**Description:**

Purge inactive Auxiliary Code(s) older than the configured interval for a given organization.

POST/organization/ **{orgid}**/auxiliary-code/purge-inactive-entities
...
POST/organization//auxiliary-code/purge-inactive-entities
...
--url https://api.wxcc-us1.cisco.com/organization//auxiliary-code/purge-inactive-entities \
