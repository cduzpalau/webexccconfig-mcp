[Home](https://developer.webex.com/)/[Entry Point](https://developer.webex.com/webex-contact-center/docs/api/v1/entry-point)/Bulk export Entry Point(s)
...
Indicates the type of Entrypoint; can be INBOUND or OUTBOUND.
...
- -BulkExportDTOEntryPointBulkExportDTO
  ...
  - +resources:EntryPointBulkExportDTO\[\]
...
GET/organization//entry-point/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//entry-point/bulk-export?type= \
