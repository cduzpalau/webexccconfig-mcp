[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Delete specific Auxiliary Code by ID
...
Resource ID of the Auxiliary Code.
...
DELETE/organization//auxiliary-code/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//auxiliary-code/{id} \
