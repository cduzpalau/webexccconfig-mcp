[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/Create a new Audio File
...
--url https://api.wxcc-us1.cisco.com/organization//audio-file \
