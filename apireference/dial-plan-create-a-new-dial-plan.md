[Home](https://developer.webex.com/)/[Dial Plan](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-plan)/Create a new Dial Plan
...
--url https://api.wxcc-us1.cisco.com/organization//dial-plan \
