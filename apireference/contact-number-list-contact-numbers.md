[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/List Contact Number(s)
...
**Operation Id:** getAllConfigWithMetaData\_19
...
GET/organization//v2/contact-number
...
--url https://api.wxcc-us1.cisco.com/organization//v2/contact-number \
