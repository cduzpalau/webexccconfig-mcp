[Home](https://developer.webex.com/)/[Holiday List](https://developer.webex.com/webex-contact-center/docs/api/v1/holiday-list)/Delete specific Holiday List by ID
...
**Operation Id:** deleteConfig\_12

**Description:**

Delete an existing Holiday List by ID in a given organization.
...
Resource ID of the Holiday List.
...
DELETE/organization//holiday-list/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//holiday-list/{id} \
