[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/List Contact Service Queue(s)
...
GET/organization//v3/contact-service-queue
...
--url https://api.wxcc-us1.cisco.com/organization//v3/contact-service-queue \
