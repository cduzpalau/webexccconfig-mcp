[Home](https://developer.webex.com/)/[Entry Point](https://developer.webex.com/webex-contact-center/docs/api/v1/entry-point)/Create a new Entry Point
...
**Operation Id:** createConfig\_14

**Description:**

Create a new Entry Point in a given organization.

POST/organization/ **{orgid}**/entry-point
...
--url https://api.wxcc-us1.cisco.com/organization//entry-point \
