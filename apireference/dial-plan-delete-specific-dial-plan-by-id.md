[Home](https://developer.webex.com/)/[Dial Plan](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-plan)/Delete specific Dial Plan by ID
...
DELETE/organization//dial-plan/ **{id}**
