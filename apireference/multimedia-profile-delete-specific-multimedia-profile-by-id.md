[Home](https://developer.webex.com/)/[Multimedia Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/multimedia-profile)/Delete specific Multimedia Profile by ID
...
DELETE/organization//multimedia-profile/ **{id}**
