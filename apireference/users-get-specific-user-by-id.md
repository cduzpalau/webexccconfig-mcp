[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/Get specific User by ID
...
**Operation Id:** getConfig\_3

**Description:**

Retrieve an existing Users by ID in a given organization.
...
If `true`, the API response will include the count of each type of Contact Service Queues which are assigned to user.

default = false

includeSkillProfileAuditboolean

If set to true gives skill profile modification info.
