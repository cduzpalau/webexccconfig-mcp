[Home](https://developer.webex.com/)/[Agent Personal Greeting](https://developer.webex.com/webex-contact-center/docs/api/v1/agent-personal-greeting)/Get All Config With Meta Data
...
**Operation Id:** getAllConfigWithMetaData
...
- -object
  ...
  - +data:AgentPersonalGreetingDTO\_AgentPersonalGreetingsWithAttributeTag\[\]
...
GET/organization//v2/agent-personal-greeting
...
--url https://api.wxcc-us1.cisco.com/organization//v2/agent-personal-greeting \
