[Home](https://developer.webex.com/)/[Dial Plan](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-plan)/List Dial Plan(s)
...
**Operation Id:** getAllConfigWithMetaData\_16

**Description:**

Retrieve a list of Dial Plan(s) in a given organization.
...
--url https://api.wxcc-us1.cisco.com/organization//v2/dial-plan \
