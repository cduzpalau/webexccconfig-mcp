[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Delete specific Address Book by ID
...
**Operation Id:** deleteConfig\_2

**Description:**

Delete an existing Address Book by ID in a given organization.

DELETE/organization/ **{orgid}/v3/address-book/{id}**
...
DELETE/organization//v3/address-book/ **{id}**
