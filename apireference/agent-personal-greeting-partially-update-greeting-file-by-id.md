[Home](https://developer.webex.com/)/[Agent Personal Greeting](https://developer.webex.com/webex-contact-center/docs/api/v1/agent-personal-greeting)/Partially update Greeting File by ID
...
**Operation Id:** patchConfig\_4

**Description:**

Partially update Greeting File by ID in a given organization.

PATCH/organization/ **{orgid}/agent-personal-greeting/{id}**
...
- -AgentPersonalGreetingPatchDTO\_AgentPersonalGreetingsWithAttributeTag
...
PATCH/organization//agent-personal-greeting/ **{id}**
