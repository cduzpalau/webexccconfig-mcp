[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/List Audio File(s)
...
**Operation Id:** getAllConfigWithMetaData\_24
...
Specify the attributes to be returned.Default all attributes are returned along with specified columns. All Attributes are supported except URL
...
GET/organization//v2/audio-file
...
--url https://api.wxcc-us1.cisco.com/organization//v2/audio-file \
