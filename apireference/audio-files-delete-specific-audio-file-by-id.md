[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/Delete specific Audio File by ID
...
DELETE/organization//audio-file/ **{id}**
