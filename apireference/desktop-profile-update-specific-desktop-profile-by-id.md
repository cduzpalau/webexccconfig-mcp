[Home](https://developer.webex.com/)/[Desktop Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-profile)/Update specific Desktop Profile by ID
...
**Operation Id:** updateConfig\_28

**Description:**

Update an existing Desktop Profile by ID in a given organization.

PUT/organization/ **{orgid}/agent-profile/{id}**
...
Resource ID of the Desktop Profile.
...
```json
{
    ...
    "accessIdleCode": "ALL",
    "idleCodes": [ "aux_code_sale", "aux_code2" ],
    "accessQueue": "ALL",
    "queues": [\
        "apim_queue_516789",\
        "apim_queue_6123456"\
    ...
    "agentDNValidationCriterions": [ "DN_5_Sept", "DN_7_Jan" ],
    "loginVoiceOptions": [\
        "AGENT_DN",\
        "EXTENSION",\
        "BROWSER"\
...
```json
{
    ...
    "agentDNValidationCriteria": "SPECIFIC",
    "agentDNValidationCriterions": [ "DN_5_Sept", "DN_7_Jan" ],
    "loginVoiceOptions": [ "AGENT_DN", "EXTENSION" ],
    "viewableStatistics": {
        "organizationId": "f53c8b54-46ca-43f6-ba05-08426a46e23d",
        "id": "93912f11-6017-404b-bf14-5331890b1797",
        "version": 1,
...
PUT/organization//agent-profile/ **{id}**
...
SPECIFICALLPROVISIONED\_VALUENONE
...
Add agentDNValidationCriterions

loginVoiceOptions

Login voice options.

AGENT\_DNEXTENSIONBROWSER
...
--url https://api.wxcc-us1.cisco.com/organization//agent-profile/{id} \
--header 'Authorization: Bearer ' \
--header 'Content-Type: application/json' \
--header 'Accept: */*' \
--data '{ "viewableStatistics": {} }'
```
