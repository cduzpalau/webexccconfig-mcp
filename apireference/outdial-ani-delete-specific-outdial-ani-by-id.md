[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/Delete specific Outdial ANI by ID
...
DELETE/organization//outdial-ani/ **{id}**
