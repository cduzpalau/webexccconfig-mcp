[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/List references for a specific Auxiliary Code
...
**Operation Id:** getIncomingReferences\_18

**Description:**

Retrieve a list of all entities that have reference to an existing Auxiliary Code by ID in a given organization.
...
GET/organization//auxiliary-code/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//auxiliary-code/{id}/incoming-references \
