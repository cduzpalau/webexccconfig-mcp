[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/Bulk save Contact Number(s)
...
**Operation Id:** saveAllConfig\_17

**Description:**

Create, Update or delete Contact Number(s) in bulk in a given organization.

POST/organization/ **{orgid}**/contact-number/bulk
...
- -BulkRequestDTOContactNumberDTO
  ...
  - +items:BulkRequestItemDTOContactNumberDTO\[\]
...
POST/organization//contact-number/bulk
...
--url https://api.wxcc-us1.cisco.com/organization//contact-number/bulk \
