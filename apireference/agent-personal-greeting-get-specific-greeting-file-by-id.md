[Home](https://developer.webex.com/)/[Agent Personal Greeting](https://developer.webex.com/webex-contact-center/docs/api/v1/agent-personal-greeting)/Get specific Greeting File by ID
...
**Operation Id:** getConfig\_28

**Description:**

Retrieve an existing Greeting File by ID in a given organization.

GET/organization/ **{orgid}/agent-personal-greeting/{id}**
...
Resource ID of the Greeting File.
...
Indicates if the URL for downloading Greeting Fileshould be included in the response.
...
GET/organization//agent-personal-greeting/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//agent-personal-greeting/{id} \
