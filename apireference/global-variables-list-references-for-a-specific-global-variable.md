[Home](https://developer.webex.com/)/[Global Variables](https://developer.webex.com/webex-contact-center/docs/api/v1/global-variables)/List references for a specific Global Variable
...
**Operation Id:** getIncomingReferences\_16

**Description:**

Retrieve a list of all entities that have reference to an existing Global Variable by ID in a given organization.

GET/organization/ **{orgid}/cad-variable/{id}**/incoming-references
...
GET/organization//cad-variable/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//cad-variable/{id}/incoming-references \
