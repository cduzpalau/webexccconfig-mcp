[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/List Address Book(s)
...
GET/organization//v3/address-book
