[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Create a new Address Book
...
POST/organization//v3/address-book
...
--url https://api.wxcc-us1.cisco.com/organization//v3/address-book \
