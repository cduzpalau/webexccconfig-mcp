[Home](https://developer.webex.com/)/[Desktop Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-profile)/Delete specific Desktop Profile by ID
...
DELETE/organization//agent-profile/ **{id}**
