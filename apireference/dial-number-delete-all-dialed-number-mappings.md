[Home](https://developer.webex.com/)/[Dial Number](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-number)/Delete all Dialed Number Mapping(s)
...
DELETE/organization//dial-number
...
--url https://api.wxcc-us1.cisco.com/organization//dial-number \
