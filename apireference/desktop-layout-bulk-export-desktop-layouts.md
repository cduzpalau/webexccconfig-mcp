[Home](https://developer.webex.com/)/[Desktop Layout](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-layout)/Bulk export Desktop Layout(s)
...
**Operation Id:** bulkExport\_15

**Description:**

Export all Desktop Layout(s) in a given organization.

GET/organization/ **{orgid}**/desktop-layout/bulk-export
...
- -BulkExportDTODesktopLayoutBulkExportDTO
  ...
  - +resources:DesktopLayoutBulkExportDTO\[\]
...
GET/organization//desktop-layout/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//desktop-layout/bulk-export \
