[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/Partially update Audio File by ID
...
PATCH/organization//audio-file/ **{id}**
