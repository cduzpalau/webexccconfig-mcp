[Home](https://developer.webex.com/)/[Business Hours](https://developer.webex.com/webex-contact-center/docs/api/v1/business-hours)/List references for a specific Business Hours resource
...
**Operation Id:** getIncomingReferences\_17

**Description:**

Retrieve a list of all entities that have reference to an existing Business Hours resource by ID in a given organization.

GET/organization/ **{orgid}/business-hours/{id}**/incoming-references
...
GET/organization//business-hours/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//business-hours/{id}/incoming-references \
