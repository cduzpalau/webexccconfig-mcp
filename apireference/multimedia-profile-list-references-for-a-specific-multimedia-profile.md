[Home](https://developer.webex.com/)/[Multimedia Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/multimedia-profile)/List references for a specific Multimedia Profile
...
**Operation Id:** getIncomingReferences\_9

**Description:**

Retrieve a list of all entities that have reference to an existing Multimedia Profile by ID in a given organization.

GET/organization/ **{orgid}/multimedia-profile/{id}**/incoming-references
...
GET/organization//multimedia-profile/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//multimedia-profile/{id}/incoming-references \
