[Home](https://developer.webex.com/)/[Desktop Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-profile)/Purge inactive Desktop Profile(s)
...
**Operation Id:** purgeInactiveConfig\_11

**Description:**

Purge inactive Desktop Profile(s) older than the configured interval for a given organization.

POST/organization/ **{orgid}**/agent-profile/purge-inactive-entities
...
POST/organization//agent-profile/purge-inactive-entities
...
--url https://api.wxcc-us1.cisco.com/organization//agent-profile/purge-inactive-entities \
