[Home](https://developer.webex.com/)/[Agent Personal Greeting](https://developer.webex.com/webex-contact-center/docs/api/v1/agent-personal-greeting)/Update specific Greeting File by ID
...
Update specific Greeting File by ID in a given organization.

PUT/organization/ **{orgid}/agent-personal-greeting/{id}**
...
PUT/organization//agent-personal-greeting/ **{id}**
