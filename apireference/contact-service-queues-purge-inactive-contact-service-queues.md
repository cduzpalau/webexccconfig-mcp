[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/Purge inactive Contact Service Queue(s)
...
**Operation Id:** purgeInactiveConfig\_8

**Description:**

Purge inactive Contact Service Queue(s) older than the configured interval for a given organization.
...
POST/organization//contact-service-queue/purge-inactive-entities
...
--url https://api.wxcc-us1.cisco.com/organization//contact-service-queue/purge-inactive-entities \
