[Home](https://developer.webex.com/)/[Holiday List](https://developer.webex.com/webex-contact-center/docs/api/v1/holiday-list)/List references for a specific Holiday List
...
**Operation Id:** getIncomingReferences\_10

**Description:**

Retrieve a list of all entities that have reference to an existing Holiday List by ID in a given organization.

GET/organization/ **{orgid}/holiday-list/{id}**/incoming-references
...
GET/organization//holiday-list/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//holiday-list/{id}/incoming-references \
