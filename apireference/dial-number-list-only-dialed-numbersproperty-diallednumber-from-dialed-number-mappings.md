[Home](https://developer.webex.com/)/[Dial Number](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-number)/List only dialed numbers(property - dialledNumber) from Dialed Number Mapping(s)
...
GET/organization//dial-number/numbers-only
...
--url https://api.wxcc-us1.cisco.com/organization//dial-number/numbers-only \
