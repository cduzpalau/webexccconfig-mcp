[Home](https://developer.webex.com/)/[Multimedia Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/multimedia-profile)/Update specific Multimedia Profile by ID
...
**Operation Id:** updateConfig\_12

**Description:**

Update an existing Multimedia Profile by ID in a given organization.

PUT/organization/ **{orgid}/multimedia-profile/{id}**
...
Resource ID of the Multimedia Profile.
...
PUT/organization//multimedia-profile/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//multimedia-profile/{id} \
