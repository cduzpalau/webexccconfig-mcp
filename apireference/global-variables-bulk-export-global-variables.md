[Home](https://developer.webex.com/)/[Global Variables](https://developer.webex.com/webex-contact-center/docs/api/v1/global-variables)/Bulk export Global Variable(s)
...
- -BulkExportDTOCadVariableBulkExportDTO
  ...
  - +resources:CadVariableBulkExportDTO\[\]
...
GET/organization//cad-variable/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//cad-variable/bulk-export \
