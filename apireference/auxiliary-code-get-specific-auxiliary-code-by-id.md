[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Get specific Auxiliary Code by ID
...
**Operation Id:** getConfig\_24

**Description:**

Retrieve an existing Auxiliary Code by ID in a given organization.

GET/organization/ **{orgid}/auxiliary-code/{id}**
...
GET/organization//auxiliary-code/ **{id}**
