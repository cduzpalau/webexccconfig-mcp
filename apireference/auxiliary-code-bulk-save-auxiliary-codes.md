[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Bulk save Auxiliary Code(s)
...
**Operation Id:** saveAllConfig\_20
...
POST/organization//auxiliary-code/bulk
