[Home](https://developer.webex.com/)/[Dial Number](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-number)/Get specific Dialed Number Mapping by ID
...
GET/organization//dial-number/ **{id}**
