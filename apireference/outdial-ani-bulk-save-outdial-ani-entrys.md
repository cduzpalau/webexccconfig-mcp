[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/Bulk save Outdial ANI Entry(s)
...
**Operation Id:** saveAllConfig\_8

**Description:**

Create, Update or delete Outdial ANI Entry(s) in bulk for an Address Book in a given organization.
...
- -BulkRequestDTOOutdialANIEntryDTO
  ...
  - +items:BulkRequestItemDTOOutdialANIEntryDTO\[\]
...
POST/organization//outdial-ani/ **{outDialAniId}**/entry/bulk
...
--url https://api.wxcc-us1.cisco.com/organization//outdial-ani/{outDialAniId}/entry/bulk \
