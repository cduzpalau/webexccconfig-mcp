[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/Bulk export User(s)
...
**Operation Id:** bulkExport\_2

**Description:**

Export all User(s) in a given organization.

GET/organization/ **{orgid}**/user/bulk-export
...
- -BulkExportDTOUserBulkExportDTO
  ...
  - +resources:UserBulkExportDTO\[\]
    ...
    - preferredSupervisorTeam:string
...
GET/organization//user/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//user/bulk-export \
