[Home](https://developer.webex.com/)/[Business Hours](https://developer.webex.com/webex-contact-center/docs/api/v1/business-hours)/Delete specific Business Hours resource by ID
...
**Operation Id:** deleteConfig\_21

**Description:**

Delete an existing Business Hours resource by ID in a given organization.

DELETE/organization/ **{orgid}/business-hours/{id}**
...
Resource ID of the Business Hours resource.
...
DELETE/organization//business-hours/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//business-hours/{id} \
