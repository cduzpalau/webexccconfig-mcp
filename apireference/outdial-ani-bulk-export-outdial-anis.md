[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/Bulk export Outdial ANI(s)
...
**Operation Id:** bulkExport\_9

**Description:**

Export all Outdial ANI(s) in a given organization.

GET/organization/ **{orgid}**/outdial-ani/bulk-export
...
- -BulkExportDTOOutdialANIBulkExportDTO
  ...
  - +resources:OutdialANIBulkExportDTO\[\]

    - description:string

    - name:string

    - +entryDetails:OutdialANIEntryDetailsDTO\[\]
...
GET/organization//outdial-ani/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//outdial-ani/bulk-export \
