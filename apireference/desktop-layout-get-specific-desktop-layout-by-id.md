[Home](https://developer.webex.com/)/[Desktop Layout](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-layout)/Get specific Desktop Layout by ID
...
GET/organization//desktop-layout/ **{id}**
