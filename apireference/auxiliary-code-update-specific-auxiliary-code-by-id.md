[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Update specific Auxiliary Code by ID
...
PUT/organization//auxiliary-code/ **{id}**
