[Home](https://developer.webex.com/)/[Global Variables](https://developer.webex.com/webex-contact-center/docs/api/v1/global-variables)/Update specific Global Variable by ID
...
PUT/organization//cad-variable/ **{id}**
