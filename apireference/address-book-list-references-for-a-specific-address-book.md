[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/List references for a specific Address Book
...
**Operation Id:** getIncomingReferences\_21
...
GET/organization//address-book/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//address-book/{id}/incoming-references \
