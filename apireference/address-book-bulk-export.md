[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Bulk export Address Book(s)
...
- -BulkExportDTOAddressBookBulkExportDTO
  ...
  - +resources:AddressBookBulkExportDTO\[\]
    ...
    - +entryDetails:AddressBookEntryDetailsDTO\[\]
...
```json
{
    ...
    "resources": [\
        {\
            ...
            "parentSite": "c7b3665d-b386-4267-8397-1331f2a26018",\
            "entryDetails": [\
                {\
                    "entryName": "James Bond",\
                    "phoneNumber": "+14033212"\
                }\
            ]\
        }\
    ]
...
GET/organization//address-book/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//address-book/bulk-export \
