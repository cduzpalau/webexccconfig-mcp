[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/Get specific User along with profile by ID
...
**Operation Id:** getUserWithUserProfile

**Description:**

Retrieve an existing User along with the corresponding UserProfile by ID in a given organization.
...
GET/organization//user/with-user-profile/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//user/with-user-profile/{id} \
