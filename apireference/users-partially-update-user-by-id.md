[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/Partially update User by ID
...
- -JsonValue
  ...
  - valueType:string
    ...
    Valid values are 'ARRAY', 'OBJECT', 'STRING', 'NUMBER', 'TRUE', 'FALSE', 'NULL'

    enum = \["ARRAY", "OBJECT", "STRING", "NUMBER", "TRUE", ...\]
...
ARRAYOBJECTSTRINGNUMBERTRUEFALSENULL
