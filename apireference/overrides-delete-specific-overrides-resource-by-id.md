[Home](https://developer.webex.com/)/[Overrides](https://developer.webex.com/webex-contact-center/docs/api/v1/overrides)/Delete specific Overrides resource by ID
...
DELETE/organization//overrides/ **{id}**
