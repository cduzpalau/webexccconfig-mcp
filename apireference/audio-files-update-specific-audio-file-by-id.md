[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/Update specific Audio File by ID
...
PUT/organization//audio-file/ **{id}**
