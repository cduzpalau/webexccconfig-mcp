[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/List references for a specific Outdial ANI
...
**Operation Id:** getIncomingReferences\_8

**Description:**

Retrieve a list of all entities that have reference to an existing Outdial ANI by ID in a given organization.

GET/organization/ **{orgid}/outdial-ani/{id}**/incoming-references
...
GET/organization//outdial-ani/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//outdial-ani/{id}/incoming-references \
