[Home](https://developer.webex.com/)/[Desktop Layout](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-layout)/Delete specific Desktop Layout by ID
...
DELETE/organization//desktop-layout/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//desktop-layout/{id} \
