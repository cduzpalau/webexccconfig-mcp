[Home](https://developer.webex.com/)/[Skill](https://developer.webex.com/webex-contact-center/docs/api/v1/skill)/Bulk export Skill(s)
...
**Operation Id:** bulkExport\_5

**Description:**

Export all Skill(s) in a given organization.

GET/organization/ **{orgid}**/skill/bulk-export
...
- -BulkExportDTOSkillBulkExportDTO
...
GET/organization//skill/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//skill/bulk-export \
