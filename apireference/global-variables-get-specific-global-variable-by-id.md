[Home](https://developer.webex.com/)/[Global Variables](https://developer.webex.com/webex-contact-center/docs/api/v1/global-variables)/Get specific Global Variable by ID
...
**Operation Id:** getConfig\_22

**Description:**

Retrieve an existing Global Variable by ID in a given organization.

GET/organization/ **{orgid}/cad-variable/{id}**
...
GET/organization//cad-variable/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//cad-variable/{id} \
