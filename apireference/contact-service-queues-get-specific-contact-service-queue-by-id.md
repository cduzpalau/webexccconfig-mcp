[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/Get specific Contact Service Queue by Id
...
agentsUpdatedInfoboolean

If `true`, returns the user details who has last updated the agents list in an agent based queue.
...
GET/organization//v2/contact-service-queue/ **{id}**
