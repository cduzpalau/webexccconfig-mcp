[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/Create a new Contact Number
...
**Operation Id:** createConfig\_20

**Description:**

Create a new Contact Number in a given organization.

POST/organization/ **{orgid}**/contact-number
...
POST/organization//contact-number
...
--url https://api.wxcc-us1.cisco.com/organization//contact-number \
