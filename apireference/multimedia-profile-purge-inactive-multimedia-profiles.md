[Home](https://developer.webex.com/)/[Multimedia Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/multimedia-profile)/Purge inactive Multimedia Profile(s)
...
**Operation Id:** purgeInactiveConfig\_5

**Description:**

Purge inactive Multimedia Profile(s) older than the configured interval for a given organization.

POST/organization/ **{orgid}**/multimedia-profile/purge-inactive-entities
...
This is the entity ID from which items for the next purge batch with be selected.

example = "af9eecc5-0472-4549-9a83-2afdae0d4ba0", default = ""
...
POST/organization//multimedia-profile/purge-inactive-entities
...
--url https://api.wxcc-us1.cisco.com/organization//multimedia-profile/purge-inactive-entities \
