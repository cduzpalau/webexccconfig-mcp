[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/Get specific Contact Number by ID
...
GET/organization//contact-number/ **{id}**
