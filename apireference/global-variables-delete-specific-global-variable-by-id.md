[Home](https://developer.webex.com/)/[Global Variables](https://developer.webex.com/webex-contact-center/docs/api/v1/global-variables)/Delete specific Global Variable by ID
...
DELETE/organization//cad-variable/ **{id}**
