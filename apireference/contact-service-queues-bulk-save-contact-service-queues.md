[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/Bulk save Contact Service Queue(s)
...
**Operation Id:** saveAllConfigV2

**Description:**

Create, Update or delete Contact Service Queue(s) in bulk in a given organization.

POST/organization/ **{orgid}**/contact-service-queue/v2/bulk
...
POST/organization//contact-service-queue/v2/bulk
...
--url https://api.wxcc-us1.cisco.com/organization//contact-service-queue/v2/bulk \
