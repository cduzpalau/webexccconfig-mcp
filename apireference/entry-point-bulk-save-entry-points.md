[Home](https://developer.webex.com/)/[Entry Point](https://developer.webex.com/webex-contact-center/docs/api/v1/entry-point)/Bulk save Entry Point(s)
...
**Operation Id:** saveAllConfig\_12

**Description:**

Create, Update or delete Entry Point(s) in bulk in a given organization.

POST/organization/ **{orgid}**/entry-point/bulk
...
- -BulkRequestDTOEntryPointDTO
  ...
  - +items:BulkRequestItemDTOEntryPointDTO\[\]
...
POST/organization//entry-point/bulk
...
--url https://api.wxcc-us1.cisco.com/organization//entry-point/bulk \
