[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/List Users along with profile
...
**Operation Id:** getAllUsersWithUserProfile

**Description:**

Retrieve a list of User(s) along with their UserProfiles in a given organization.

GET/organization/ **{orgid}**/user/with-user-profile
...
GET/organization//user/with-user-profile
...
--url https://api.wxcc-us1.cisco.com/organization//user/with-user-profile \
