[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/Update specific Contact Service Queue by ID
...
**Operation Id:** updateConfig\_20

**Description:**

Update an existing Contact Service Queue by ID in a given organization.

PUT/organization/ **{orgid}/v2/contact-service-queue/{id}**
...
Resource ID of the Contact Service Queue.
...
PUT/organization//v2/contact-service-queue/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//v2/contact-service-queue/{id} \
