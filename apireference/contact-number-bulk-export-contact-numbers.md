[Home](https://developer.webex.com/)/[Contact Number](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-number)/Bulk export Contact Number(s)
...
- -BulkExportDTOContactNumberBulkExportDTO
  ...
  - +resources:ContactNumberBulkExportDTO\[\]
...
GET/organization//contact-number/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//contact-number/bulk-export \
