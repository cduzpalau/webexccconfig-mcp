[Home](https://developer.webex.com/)/[Dial Plan](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-plan)/Bulk export Dial Plan(s)
...
**Operation Id:** bulkExport\_13

**Description:**

Export all Dial Plan(s) in a given organization.

GET/organization/ **{orgid}**/dial-plan/bulk-export
...
- -BulkExportDTODialPlanBulkExportDTO
  ...
  - +resources:DialPlanBulkExportDTO\[\]
...
GET/organization//dial-plan/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//dial-plan/bulk-export \
