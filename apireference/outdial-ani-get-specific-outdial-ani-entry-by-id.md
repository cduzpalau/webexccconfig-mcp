[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/Get specific Outdial ANI Entry by ID
...
**Operation Id:** getConfig\_10

**Description:**

Retrieve an existing Outdial ANI Entry by ID in a given organization.

GET/organization/ **{orgid}/outdial-ani/{outDialAniId}/entry/{id}**
...
GET/organization//outdial-ani/ **{outDialAniId}/entry/{id}**
