[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/Delete specific Contact Service Queue by ID
...
**Operation Id:** deleteConfig\_18

**Description:**

Delete an existing Contact Service Queue by ID in a given organization.

DELETE/organization/ **{orgid}/contact-service-queue/{id}**
...
DELETE/organization//contact-service-queue/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//contact-service-queue/{id} \
