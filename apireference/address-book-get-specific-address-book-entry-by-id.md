[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Get specific Address Book Entry by ID
...
GET/organization//address-book/ **{addressBookId}/entry/{id}**
