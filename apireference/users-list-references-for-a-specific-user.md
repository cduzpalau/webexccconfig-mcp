[Home](https://developer.webex.com/)/[Users](https://developer.webex.com/webex-contact-center/docs/api/v1/users)/List references for a specific User
...
**Operation Id:** getIncomingReferences\_1

**Description:**

Retrieve a list of all entities that have reference to an existing User by ID in a given organization.

GET/organization/ **{orgid}/user/{id}**/incoming-references
...
GET/organization//user/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//user/{id}/incoming-references \
