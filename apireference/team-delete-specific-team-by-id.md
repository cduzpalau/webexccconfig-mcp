[Home](https://developer.webex.com/)/[Team](https://developer.webex.com/webex-contact-center/docs/api/v1/team)/Delete specific Team by ID
...
**Operation Id:** deleteConfig\_4

**Description:**

Delete an existing Team by ID in a given organization.
