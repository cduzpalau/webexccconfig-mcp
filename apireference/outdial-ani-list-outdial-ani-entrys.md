[Home](https://developer.webex.com/)/[Outdial ANI](https://developer.webex.com/webex-contact-center/docs/api/v1/outdial-ani)/List Outdial ANI Entry(s)
...
**Operation Id:** getAllConfigWithMetaData\_12

**Description:**

Retrieve a list of Outdial ANI Entry(s) in a given organization.

GET/organization/ **{orgid}/v2/outdial-ani/{outDialAniId}**/entry
...
GET/organization//v2/outdial-ani/ **{outDialAniId}**/entry
...
--url https://api.wxcc-us1.cisco.com/organization//v2/outdial-ani/{outDialAniId}/entry \
