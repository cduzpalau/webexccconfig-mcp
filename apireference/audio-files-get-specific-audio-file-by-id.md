[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/Get specific Audio File by ID
...
Indicates if the URL for downloading Audio Fileshould be included in the response.
...
GET/organization//audio-file/ **{id}**
...
--url https://api.wxcc-us1.cisco.com/organization//audio-file/{id} \
