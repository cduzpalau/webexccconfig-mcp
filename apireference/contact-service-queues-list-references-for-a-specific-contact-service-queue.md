[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/List references for a specific Contact Service Queue
...
**Operation Id:** getIncomingReferences\_15

**Description:**

Retrieve a list of all entities that have reference to an existing Contact Service Queue by ID in a given organization.
...
GET/organization//contact-service-queue/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//contact-service-queue/{id}/incoming-references \
