[Home](https://developer.webex.com/)/[Contact Service Queues](https://developer.webex.com/webex-contact-center/docs/api/v1/contact-service-queues)/List skill based Contact Service Queue(s)by user ID
...
**Operation Id:** getSkillBasedQueuesByUserId

**Description:**

Retrieve a list of skill based Contact Service Queue(s) by user id in a given organization.
...
GET/organization//v2/contact-service-queue/by-user-id/ **{userid}**/skill-based-queues
...
--url https://api.wxcc-us1.cisco.com/organization//v2/contact-service-queue/by-user-id/{userid}/skill-based-queues \
