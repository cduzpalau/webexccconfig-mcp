[Home](https://developer.webex.com/)/[Desktop Profile](https://developer.webex.com/webex-contact-center/docs/api/v1/desktop-profile)/Get specific Desktop Profile by ID
...
GET/organization//agent-profile/ **{id}**
