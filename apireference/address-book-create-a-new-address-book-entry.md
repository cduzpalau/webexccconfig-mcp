[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Create a new Address Book Entry
...
POST/organization//address-book/ **{addressBookId}**/entry
...
--url https://api.wxcc-us1.cisco.com/organization//address-book/{addressBookId}/entry \
