[Home](https://developer.webex.com/)/[Audio Files](https://developer.webex.com/webex-contact-center/docs/api/v1/audio-files)/List references for a specific Audio File
...
**Operation Id:** getIncomingReferences\_19

**Description:**

Retrieve a list of all entities that have reference to an existing Audio File by ID in a given organization.

GET/organization/ **{orgid}/audio-file/{id}**/incoming-references
...
GET/organization//audio-file/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//audio-file/{id}/incoming-references \
