[Home](https://developer.webex.com/)/[Dial Plan](https://developer.webex.com/webex-contact-center/docs/api/v1/dial-plan)/List references for a specific Dial Plan
...
Retrieve a list of all entities that have reference to an existing Dial Plan by ID in a given organization.

GET/organization/ **{orgid}/dial-plan/{id}**/incoming-references
...
GET/organization//dial-plan/ **{id}**/incoming-references
...
--url https://api.wxcc-us1.cisco.com/organization//dial-plan/{id}/incoming-references \
