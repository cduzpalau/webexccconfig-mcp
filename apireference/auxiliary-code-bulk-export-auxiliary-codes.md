[Home](https://developer.webex.com/)/[Auxiliary Code](https://developer.webex.com/webex-contact-center/docs/api/v1/auxiliary-code)/Bulk export Auxiliary Code(s)
...
- -BulkExportDTOAuxCodeBulkExportDTO
  ...
  - +resources:AuxCodeBulkExportDTO\[\]

    - defaultCode:string


      Indicates the default work code for your organization.
...
GET/organization//auxiliary-code/bulk-export
...
--url https://api.wxcc-us1.cisco.com/organization//auxiliary-code/bulk-export \
