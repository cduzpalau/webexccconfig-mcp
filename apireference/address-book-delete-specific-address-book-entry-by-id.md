[Home](https://developer.webex.com/)/[Address Book](https://developer.webex.com/webex-contact-center/docs/api/v1/address-book)/Delete specific Address Book Entry by ID
...
DELETE/organization//address-book/ **{addressBookId}/entry/{id}**
